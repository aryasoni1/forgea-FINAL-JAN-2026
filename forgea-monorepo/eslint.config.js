...
export default [
  {
    ignores: ["**/node_modules/**", "**/.turbo/**", "**/dist/**", "**/.next/**"],
  },
  {
    files: [
      "apps/**/*.{ts,tsx,js,jsx}",
    ...
    settings: {
      "boundaries/elements": [
        ...
        { type: "service-content-engine", pattern: "services/content-engine/**" },
        { type: "service-verification-runner", pattern: "services/verification-runner/**" },
      ...
      "boundaries/element-types": [
        "error",
        {
          ...
          rules: [
            ...
            { from: "service-api-core", allow: ["service-api-core", "package"] },
            { from: "service-content-engine", allow: ["service-content-engine", "package"] },
            {
